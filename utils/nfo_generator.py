...
"""
        ...
        # Add original filename if different
        if extra_info and extra_info.get('original_filename'):
            original_filename = extra_info['original_filename']
            if original_filename != release_name:
